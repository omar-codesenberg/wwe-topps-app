 ...
 */
function assertNoForbiddenKeys(root, maxDepth) {
...
describe('paypal/client — [C21] error sanitization', () => {
    ...
    test('Success: caller projection applied; raw body fields not reachable', async () => {
        ...
        const client = require('../paypal/client');
        client._resetTokenCacheForTests();
        const out = await client.request('POST', '/v2/checkout/orders', undefined, {
            project: (r) => {
                const body = r;
...
//# sourceMappingURL=clientErrorSanitization.test.js.map